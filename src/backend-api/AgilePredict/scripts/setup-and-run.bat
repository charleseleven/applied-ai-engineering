@echo off
REM ==========================================
REM SETUP COMPLETO - GROQ + LLAMA-4
REM ==========================================

echo.
echo ==================================================
echo 🦙 CONFIGURAÇÃO COMPLETA - GROQ + LLAMA-4
echo ==================================================
echo.
...
echo ==================================================
echo 📦 PASSO 1: Instalando pacotes NuGet necessários
echo ==================================================
echo.
...
echo ==================================================
echo 🔨 PASSO 3: Compilando o projeto
echo ==================================================
echo.
...
REM ==========================================
REM PASSO 4: Iniciar a Aplicação
REM ==========================================

echo ==================================================
echo 🚀 PASSO 4: Iniciando a aplicação
echo ==================================================
echo.
